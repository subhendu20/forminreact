...
import { TextField, Select, MenuItem, RadioGroup, OutlinedInput, FormControlLabel, Radio, Stack, Chip, Checkbox, FormControl, InputLabel, ListItemText, Autocomplete } from '@mui/material';
...
function Formcomponent() {
          ...
          const handleSubmit = async(values) => {
                    values.hobbies=await selectedhobbies;
                    console.log(values)
          };
          return (

                    <Formik initialValues={initialValues} onSubmit={handleSubmit} validationSchema={formSchema} className='form'>
                              {
                                        ({ errors, touched }) => (
                                                  <Form className='formcomponents'>

                                                            <Field name="name" as={TextField} label="Name" className='span' />
                                                            ...
                                                            <FormControl component="fieldset" className='span'>
                                                                      <Field as={RadioGroup} name="gender" className='radio-span'>
